...
class Accounts extends BaseValidate
{
    protected $rule = [
        ...
        'captcha'  => 'require|length:5|alphaNum|checkCode'
    ];
    ...
    protected $message = [
        ...
        'captcha.alphaNum'    => '验证码只能为字母和数字',
        'captcha.length'      => '请输入正确的验证码',
        'captcha.checkCode'   => '请输入正确的验证码',
    ...
    {
        return $this->only(['nickname', 'passwd', 'captcha'])
     ...
     * @return Boolean
     */
    protected function checkCode(String $value): Bool
    {
        return (new CaptchaUtil)->check($value);
    }
}
